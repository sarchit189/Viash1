...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/Viash1/Viash1/src/template/take_column/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'column': $( if [ ! -z ${VIASH_PAR_COLUMN+x} ]; then echo "int(r'${VIASH_PAR_COLUMN//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "viash-io/project_template/template/take_column",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
